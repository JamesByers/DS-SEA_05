##![](https://ga-dash.s3.amazonaws.com/production/assets/logo-9f88ae6c9c3871690e33280fcf557f33.png)  DS-SEA-4 course repository
...
11/1 [L13 Natural Language Processing](#nlp1) | 11/3: [L14 Dimensionality reduction](#reduction), **Draft Paper Due**
11/8: [L15 Decision Trees](#decision) | 11/10: [L16 Ensembling, Bagging and Random Forests](#ensemble)
11/15: [L17 Modeling with Time Series Data I](#time1), **Peer Review Due** | 11/17 [L18 Modeling with Time Series Data II](#time2)
11/22: [L19 Where to go next + bonus topics](#19_topics) | Thanksgiving Holiday, no class
11/29: L20 **Final Project Presentations** | 
 | 
 | 
 | 
**Bonus Content** | 
...
**Homework:**
* Due 10/6. Complete the [command line homework assignment](homework/04_command_line_chipotle.md) with the Chipotle data.
...
* Due 10/6. 
	...
	* **Optional:** Complete the homework exercise listed in the [web scraping code](code/05_web_scraping.py). It will take the place of any one homework you miss, past or future! This optional homework is due on Tuesday Oct 11.
...
**Homework:**
* Due 10/13: Complete this [homework assignment](homework/06_yelp_votes_homework.ipynb) with the [Yelp data](data/yelp.csv)
